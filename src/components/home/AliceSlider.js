...
const title = 'Procurar imóvel nunca foi tão fácil';
const subTitle = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eligendi deserunt deleniti, ullam commodi sit ipsam laboriosam velit adipisci quibusdam aliquam teneturo!';
 
const items = [
  <img src="assets/img/slide1/slider-image-1.jpg" alt="alternative" onDragStart={handleDragStart} className="sliderimg" />,
  <img src="assets/img/slide1/slider-image-2.jpg" alt="alternative" onDragStart={handleDragStart} className="sliderimg" />,
  <img src="assets/img/slide1/slider-image-4.jpg" alt="alternative" onDragStart={handleDragStart} className="sliderimg" />,
];

export const AliceSlider = () => {
    return (
        <div className="slider-area">
            <div className="slider">
                <AliceCarousel mouseTracking items={items} autoPlay autoPlayInterval="3000" infinite />
            </div>
                    ...
                    <div className="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12">
                        ...
                        <div className="search-form wow pulse" data-wow-delay="0.8s">
                            ...
                            <form action="" className=" form-inline">
                                ...
                                <div className="search-toggle home__hide-form">
