            ...
            <div className=" footer">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-3 col-sm-6 wow animate__animated animate__fadeInRight">
                        ...
                        <div className="col-md-3 col-sm-6 wow fadeInRight animated">
                            <div className="single-footer">
                                ...
                                <ul className="footer-menu">
                                    <li><a href="http://www/google.com">Properties</a>  </li> 
                                    <li><a href="http://www/google.com">Services</a>  </li> 
                                    <li><a href="http://www/google.com">Submit property </a></li> 
                                    <li><a href="http://www/google.com">Contact us</a></li> 
                                    <li><a href="http://www/google.com">fqa</a>  </li> 
                                    <li><a href="fhttp://www/google.com">Terms </a>  </li> 
                                </ul>
                            </div>
                        </div>
                        <div className="col-md-3 col-sm-6 wow fadeInRight animated">
                                    ...
                                    <li>
                                        <div className="col-md-3 col-sm-4 col-xs-4 blg-thumb p0">
                                            <a href="http://www/google.com">
                                                <img src="assets/img/demo/small-proerty-2.jpg" alt="One text" />
                                            </a>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="bottom-menu pull-right"> 
                            <ul> 
                                <li><a className="wow fadeInUp animated" href="http://www/google.com" data-wow-delay="0.2s">Home</a></li>
                                <li><a className="wow fadeInUp animated" href="http://www/google.com" data-wow-delay="0.3s">Property</a></li>
                                <li><a className="wow fadeInUp animated" href="http://www/google.com" data-wow-delay="0.4s">Faq</a></li>
                                <li><a className="wow fadeInUp animated" href="http://www/google.com" data-wow-delay="0.6s">Contact</a></li>
                            </ul> 
                        </div>
                    </div>
                </div>
